...
def test_fill_in_missing_data_with_average():
    timestamps, timestamps1, timestamps2, values, d = initialize_data()
    data_sp = {
...
def test_fill_in_missing_data_with_zero():
    timestamps, timestamps1, timestamps2, values, d = initialize_data()
    data_sp = {
        'Timestamp': timestamps,
        'Value': values
...
def test_fill_in_missing_data_with_copying_last():
    timestamps, timestamps1, timestamps2, values, d = initialize_data()
    data_sp = {
        'Timestamp': timestamps,
        'Value': values
...
def test_clean_by_multiple_sliding_window():
    timestamps, timestamps1, timestamps2, values, d = initialize_data()

...
from corerl.data_pipeline.pipeline import StageTemporalState, PipelineFrame, StageCode
...
class BaseStateConstructor(ABC):
    ...
    def __call__(self, pf: PipelineFrame, tag: str) -> PipelineFrame:
        ...
        pf.temporal_state = pf.temporal_state.update(new_sc_ts, self.stage_code)

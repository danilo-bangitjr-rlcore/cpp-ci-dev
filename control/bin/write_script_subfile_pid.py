...
def stable_gac_test(settings, shared_settings, target_agents):
    ...
    def reward_stay(settings, shared_settings):
        ...
        shared_settings["--env_info"] = [[0.01, 3.]]

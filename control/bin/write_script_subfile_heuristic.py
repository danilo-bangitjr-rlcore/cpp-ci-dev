...
def c20240209(settings, shared_settings, target_agents):
    ...
    """
    cmds = [
        "python3 main.py  --param 0  --agent_name LineSearchGAC  --rho 0.1  --tau 0  --prop_rho_mult 2  --version 1  --max_steps 50000 --timeout 1000 --log_interval 1000  --debug 0  --render 0  --polyak 0.995  --beta_parameter_bias 1.0  --head_activation ReLU  --optimizer SGD  --env_name Acrobot-v1  --env_info 1.0 3.0  --discrete_control 1  --buffer_size 50000  --batch_size 512  --exp_name /heuristic/  --activation ReLU  --lr_actor 1  --lr_critic 1  --etc_buffer_prefill 1  --exp_info /supervised_explore_1/  --seed 0 --actor Softmax --hidden_actor 256 256 --layer_init_actor Xavier/1 --beta_parameter_bound 10000 --gamma 0.95 --exploration 1",
    ]
    # write_cmd(cmds, prev_file=0, line_per_file=1)
...
if __name__=='__main__':
    ...
    c20240209(copy.deepcopy(settings), copy.deepcopy(shared_settings), copy.deepcopy(target_agents))

...
async def main():
    ...
    db_settings_pth = "/Users/revanmacqueen/RL-Core/root/control/src/environment/reseau/db_settings_osoyoos.json"
    db_settings = json.load(open(db_settings_pth, "r"))
    opc_settings_pth = "/Users/revanmacqueen/RL-Core/root/control/src/environment/reseau/opc_settings_osoyoos.json"
    opc_settings = json.load(open(opc_settings_pth, "r"))
    ...
    env = InfluxOPCEnv(db_client, opc_connection, runtime=10, 
                    control_tags=[FPM_control_tag], 
                    offline_data_folder=data_folder, date_col=date_col, col_names=col_names)
